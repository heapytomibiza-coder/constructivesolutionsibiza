/**
 * JobLifecycleBar — context-aware status bar that signposts users
 * to the Job Ticket page for structured lifecycle actions.
 * Chat stays informal; structured actions live on /dashboard/jobs/:jobId.
 */

import { useTranslation } from "react-i18next";
import { useNavigate } from "react-router-dom";
import { Button } from "@/components/ui/button";
import { DollarSign, ArrowRight, Clock, Hammer, CheckCircle2, Star, ExternalLink } from "lucide-react";
...
export function JobLifecycleBar({
  ...
  if (jobStatus === "open") {
    ...
    subtext = t("lifecycle.manageFromTicket", "Manage progress and milestones from the job page.");
    variant = "active";
    action = viewJobButton;
