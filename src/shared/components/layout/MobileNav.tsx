...
export function MobileNav() {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="left" className="flex w-[280px] flex-col overflow-hidden sm:w-[320px]">
            ...
            <>
              ...
              <div className="mb-2 px-3">
                <Link
                  to={dashboardPath}
                  onClick={() => setOpen(false)}
                  className="flex items-center gap-3 rounded-md bg-muted/50 px-3 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-muted"
                >
                  {t('nav.dashboard')}
                </Link>
                <Link
                  to="/messages"
                  onClick={() => setOpen(false)}
                  className="mt-1 flex items-center gap-3 rounded-md px-3 py-2.5 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
                >
              ...
              <button
                ...
                className="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-left text-sm font-medium text-muted-foreground transition-colors hover:bg-destructive/10 hover:text-destructive"
              >
